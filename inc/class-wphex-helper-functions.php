...
if (!class_exists('wphex_Helper_Functions')) {
	...
	class wphex_Helper_Functions
	{
		...
		* */
		...
		public function is_wphex_master_active(){
			return defined('Hexcoupon_MASTER_SELF_PATH') ? true : false;
		}
    ...
    if( class_exists( 'CSF' ) ) {
        ...
        $prefix = 'hexcoupon_framework';

        //
        // Create options
        CSF::createOptions( $prefix, array(
            'menu_title' => 'HexCoupon Options',
            'menu_slug'  => 'HexCoupon-options',
        ) );
        ...
        // Create section for footer logo and menus
        CSF::createSection( $prefix, array(
            'title'  => 'Footer Logo and Social Links',
            'fields' => array(
		...
		CSF::createSection( $prefix.'-metabox-field', array(
            'title'  => esc_html__('Show search box','bytesed-master'),
            'fields' => array(
        ...
        // Pricing Section
        CSF::createSection( $prefix.'-metabox-field', array(
            'title'  => esc_html__('Pricing Section','hexcoupon-master'),
            'fields' => array(
                array(
        ...
        $prefix = 'hexcoupon_custom_menu_fields';
        ...
        CSF::createSection( $prefix, array(
            'fields' => array(
                ...
                array(
                    'id'    => 'subtitle_theme',
                    'type'  => 'select',
                    'title' => 'Select Subtitle for Theme',
                    'options' => [
                        'blue' => 'Blue',
                        'green' => 'Green',
                        'orange' => "Orange",
