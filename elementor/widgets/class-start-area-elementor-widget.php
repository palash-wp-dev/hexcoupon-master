...
class HexCoupon_Start_Area extends Widget_Base {
    ...
    public function get_name() {
        return 'hexcoupon-start-area-widget';
    }
    ...
    public function get_title() {
        return esc_html__( 'HexCoupon Start Area', 'hexcoupon-master' );
    }
    ...
    protected function register_controls() {
        // Start area content section starts here
        $this->start_controls_section(
            'start_area_content',
            [
                'label' => esc_html__( 'Start Area Content', 'hexcoupon-master' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Coupon Features', 'hexcoupon-master' ),
        ...
        $this->add_control(
            'title_second',
            [
                'label' => esc_html__( 'Title Second', 'hexcoupon-master' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Crafted for', 'hexcoupon-master' ),
                'placeholder' => esc_html__( 'Type title text here', 'hexcoupon-master' ),
            ]
        );
        ...
        $this->add_control(
            'title_third',
            [
                'label' => esc_html__( 'Title Third', 'hexcoupon-master' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Business', 'hexcoupon-master' ),
                'placeholder' => esc_html__( 'Type title text here', 'hexcoupon-master' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'in Mind', 'hexcoupon-master' ),
                'placeholder' => esc_html__( 'Type title text here', 'hexcoupon-master' ),
            ]
        );
        ...
        $this->add_control(
            'start_list',
            [
                'label' => esc_html__( 'Start Area List', 'hexcoupon-master' ),
                ...
                'fields' => [
                    [
                        ...
                        'type' => \Elementor\Controls_Manager::TEXT,
                        'default' => esc_html__( 'Coupon starting date' , 'hexcoupon-master' ),
                        'label_block' => true,
                    ],
    ...
    protected function render() {
        ...
        ?>
        <!-- Coupon area start -->
        <section class="coupon__area scrollingWrapper pat-120 pab-120">
            <div class="container">
                <div class="new_sectionTitle">
                    <h2 class="title"><?php printf( esc_html__( '%s', 'hexcoupon-master' ), esc_html( $settings['title_first'] ) ); ?>
                        ...
                        <?php printf( esc_html__( '%s', 'hexcoupon-master' ), esc_html( $settings['title_second'] ) ); ?> <span class="title__shapes title__color">
                            <?php printf( esc_html__( '%s', 'hexcoupon-master' ), esc_html( $settings['title_third'] ) ); ?><svg width="197" height="12" viewBox="0 0 197 12" fill="none"
                            ...
                            </svg></span> <?php printf( esc_html__( '%s', 'hexcoupon-master' ), esc_html( $settings['title_last'] ) ); ?>
                    </span>
                    </h2>
                </div>
                <div class="row g-4 mt-2 align-items-center justify-content-between">
                        ...
                        <div class="business__wrap">
                            <div class="business__faq mt-4">
                                <div class="business__left">
                                    <?php if ( $settings['start_list'] ) : $count = 1; foreach ( $settings['start_list'] as $item ) : ?>
                                    <div class="business__left__item scrollingWrapper__item <?php if ( 1 == $count ) echo esc_attr( 'active' ); ?>">
                    ...
                    <div class="col-xxl-7 col-lg-6">
                        <div class="business__right works_blur_bg">
                            <?php if ( $settings['start_list'] ) : $count = 1; foreach ( $settings['start_list'] as $item ) : $image = ! empty( $item['list_image']['url'] ) ? $item['list_image']['url'] : []; ?>
                            <div class="business__right__item scrollingWrapper__thumb <?php if( 1 == $count ) echo esc_attr( 'active' ); ?>">
                                <div class="works__thumb">
                                    <img src="<?php echo esc_url( $image ); ?>" alt="business1" loading="lazy">
                                </div>
                            </div>
                            <?php $count++; endforeach; endif; ?>
                        </div>
...
Plugin::instance()->widgets_manager->register( new HexCoupon_Start_Area() );