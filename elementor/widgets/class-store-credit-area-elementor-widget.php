...
class HexCoupon_Store_Credit extends Widget_Base {
    /**
     * Get widget name.
     *
    ...
    public function get_name() {
        return 'hexcoupon-store-credit-widget';
    }
    ...
    public function get_title() {
        return esc_html__( 'HexCoupon Store Credit Area', 'hexcoupon-master' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'faq_area_content',
            [
                'label' => esc_html__( 'Content', 'hexcoupon-master' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Incentivize & Keep Customers Coming with', 'hexcoupon-master' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Store Credits', 'hexcoupon-master' ),
                'placeholder' => esc_html__( 'Type title text here', 'hexcoupon-master' ),
            ]
        );
        ...
        $this->add_control(
            'store_list',
            [
                'label' => esc_html__( 'Store List', 'hexcoupon-master' ),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => [
                    [
                        'name' => 'list_title',
                        'label' => esc_html__( 'Store Title', 'hexcoupon-master' ),
                        'type' => \Elementor\Controls_Manager::TEXT,
                        'default' => esc_html__( 'Refund on Returned Order' , 'hexcoupon-master' ),
                        'label_block' => true,
                    ],
                ],
            ]
                ...
                <div class="row g-4 gx-5 align-items-center justify-content-between">
                        ...
                        <div class="sectionItem__wrap">
                            ...
                            <div class="sectionItem__inner mt-4">
                                <ul class="sectionItem__list">
                                    <?php if ( $settings['store_list'] ) : foreach ( $settings['store_list'] as $item ) : ?>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="sectionItem__thumb">
                            <img src="<?php echo esc_url( $image ); ?>" alt="storeCredit" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <!-- Store Credit area end -->
        <?php
...
Plugin::instance()->widgets_manager->register( new HexCoupon_Store_Credit() );